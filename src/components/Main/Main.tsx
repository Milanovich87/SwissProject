    ...
    return (
        ...
        <div className="main" >
            ...
            <div className="main__content">
                ...
                <p className="text" >“ МЫ МОЖЕМ ПО-РАЗНОМУ ВИДЕТЬ КРАСОТУ И НАШИ ВКУСЫ МОГУТ ОТЛИЧАТЬСЯ. НО ГЛАВНОЕ, ЧТОБЫ ВЫ БЫЛИ УВЕРЕННЫ В СЕБЕ, СВОЁМ ОБРАЗЕ И НАСЛАЖДАЛИСЬ БЫСТРЫМИ СБОРАМИ ”</p>
            </div>
